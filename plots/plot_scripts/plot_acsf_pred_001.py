...
ax.scatter(x, acsf_ene_pred_traj, s=40, label="NN")
ax.scatter(x, acsf_ene_traj_true, s=40, label="DFT")
ax.legend()
...
ex.set_xlabel('DFT energies (kJ/mol)')
ex.set_ylabel('NN energies (kJ/mol)')
plt.tight_layout()
