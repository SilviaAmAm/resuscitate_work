...
data_ethane = h5py.File("../../datasets/NN-sq/ethane_cn_dft.hdf5", "r")
data_isobutane = h5py.File("../../datasets/NN-sq/isobutane_cn_dft.hdf5", "r")
data_isopentane = h5py.File("../../datasets/NN-sq/isopentane_cn_dft.hdf5", "r")
data_2isohex = h5py.File("../../datasets/NN-sq/2isohexane_cn_dft_pruned.hdf5", "r")
data_3isohex = h5py.File("../../datasets/NN-sq/3isohexane_cn_dft_pruned.hdf5", "r")
...
ene_methane = ene_methane[::-1]
zs_methane = zs_methane[::-1]
...
# plt.tight_layout()
plt.savefig("../zoom_scaling.png", dpi=150)
# plt.show()
