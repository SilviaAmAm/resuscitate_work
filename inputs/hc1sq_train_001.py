...
estimator = ARMP(iterations=639, l1_reg=0.00014750750721308277, l2_reg=3.500152381947014e-07, learning_rate=0.002298911356875641, representation_name='acsf',
                 representation_params=acsf_params, tensorboard=True, store_frequency=10, tensorboard_subdir="../outputs/hc1sq_train_001/tensorboard", hidden_layer_sizes=(272,179,), batch_size=23)
...
print("The time taken to train was %.2d s" % tot_time) 

estimator.save_nn("../outputs/hc1sq_train_001/hc1sq_train_001_model")
