...
np.savez("../outputs/ch4cn_ho_009.npz", idx_train, idx_test)
...
pickle.dump(estimator, open('../outputs/ch4cn_ho_009.pickle', 'wb'))
indices = np.arange(len(idx_train))
with open('../outputs/ch4cn_ho_009.csv', 'w') as f:
    for i in indices:
        f.write('%s\n' % i)
